...
namespace XstReader.ItemProperties
{
    internal class StandardProperties
    {
        ...
        public static Dictionary<EpropertyTag, string> TagToDescription = new Dictionary<EpropertyTag, string>
        {
            ...
            {(EpropertyTag)0x0003,        "AuthorizingUsers" },
            {(EpropertyTag)0x0004,        "AutoForwardComment" },
            {(EpropertyTag)0x0005,        "AutoForwarded" },
            {(EpropertyTag)0x0006,        "ContentConfidentialityAlgorithmId" },
            {(EpropertyTag)0x0007,        "ContentCorrelator" },
            {(EpropertyTag)0x0008,        "ContentIdentifier" },
            {(EpropertyTag)0x0009,        "ContentLength" },
            {(EpropertyTag)0x000a,        "ContentReturnRequested" },
            {(EpropertyTag)0x000b,        "ConversationKey" },
            {(EpropertyTag)0x000c,        "ConversionEits" },
            {(EpropertyTag)0x000d,        "ConversionWithLossProhibited" },
            {(EpropertyTag)0x000e,        "ConvertedEits" },
            {(EpropertyTag)0x000f,        "DeferredDeliveryTime" },
            {(EpropertyTag)0x0010,        "DeliverTime" },
            {(EpropertyTag)0x0011,        "DiscardReason" },
            {(EpropertyTag)0x0012,        "DisclosureOfRecipients" },
            {(EpropertyTag)0x0013,        "DistributionListExpansionHistory" },
            {(EpropertyTag)0x0014,        "DistributionListExpansionProhibited" },
            {(EpropertyTag)0x0015,        "ExpiryTime" },
            {(EpropertyTag)0x0016,        "ImplicitConversionProhibited" },
            {(EpropertyTag)0x0017,        "Importance" },
            {(EpropertyTag)0x0018,        "PROP_ACCT_DELIVERY_STORE" },
            {(EpropertyTag)0x0019,        "LatestDeliveryTime" },
            {(EpropertyTag)0x001a,        "MessageClass" },
            {(EpropertyTag)0x001b,        "MessageDeliveryId" },
            {(EpropertyTag)0x001e,        "MessageSecurityLabel" },
            {(EpropertyTag)0x001f,        "ObsoletedMessageIds" },
            {(EpropertyTag)0x0020,        "OriginallyIntendedRecipientName" },
            {(EpropertyTag)0x0021,        "OriginalEits" },
            {(EpropertyTag)0x0022,        "OriginatorCertificate" },
            {(EpropertyTag)0x0023,        "OriginatorDeliveryReportRequested" },
            {(EpropertyTag)0x0024,        "OriginatorReturnAddress" },
            {(EpropertyTag)0x0025,        "ParentKey" },
            {(EpropertyTag)0x0026,        "Priority" },
            {(EpropertyTag)0x0027,        "OriginCheck" },
            {(EpropertyTag)0x0028,        "ProofOfSubmissionRequested" },
            {(EpropertyTag)0x0029,        "ReadReceiptRequested" },
            {(EpropertyTag)0x002a,        "ReceiptTime" },
            {(EpropertyTag)0x002b,        "RecipientReassignmentProhibited" },
            {(EpropertyTag)0x002c,        "RedirectionHistory" },
            {(EpropertyTag)0x002d,        "RelatedMessageIds" },
            {(EpropertyTag)0x002e,        "OriginalSensitivity" },
            {(EpropertyTag)0x002f,        "Languages" },
            {(EpropertyTag)0x0030,        "ReplyTime" },
            ...
            {(EpropertyTag)0x0048,        "ProviderSubmitTime" },
            ...
            {(EpropertyTag)0x0056,        "OriginalAuthorSearchKey" },
            ...
            {(EpropertyTag)0x0079,        "OriginalAuthorAddressType" },
            {(EpropertyTag)0x007a,        "OriginalAuthorEmailAddress" },
            ...
            {(EpropertyTag)0x0083,        "ReportDispositionToNames" },
            {(EpropertyTag)0x0084,        "ReportDispositionToEmailAddresses" },
            {(EpropertyTag)0x0085,        "ReportDispositionOptions" },
            ...
            {(EpropertyTag)0x0e05,        "ParentDisplay" },
            ...
            {(EpropertyTag)0x0e14,        "SubmitFlags" },
